...
## Discussion - Regression tree algorithm for convergence club identification?

@postiglione2013using
- regression tree algorithm drawbacks: 
    - spatial information as nuisance
    - strict jumps on boundaries
    - not globally optimal
    - no other controls
- hence: Simulated Annealing and Iterated Conditional Modes algorithms
